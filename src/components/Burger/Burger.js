...
const burger = (props) => { // transform an object into array of the value of ingredients
    let transformedIngredients = Object.keys(props.ingredients)//Object is default JS object /  key method: returns array of keys    
    ...
    if (transformedIngredients.length === 0){
        transformedIngredients = <p>add ingrediens</p>
    }
    return (
